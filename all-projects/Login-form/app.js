...
form.addEventListener("submit",(e)=>{
    ...
    if(!isValid(emailvalue)){
        addErrorTo( 2, "Email Address is Not Valid")
    
    }else{
        removeError(2)
    }
    if(passwordvalue == ""){
        addErrorTo( 3, "Password is required")
...
const addErrorTo = (nmbr, message)=>{
    const logo = document.getElementsByTagName("img")[nmbr]
    const smalll = document.getElementsByTagName("small")[nmbr]
